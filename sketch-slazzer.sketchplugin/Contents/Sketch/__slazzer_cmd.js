...
"use strict";
/* WEBPACK VAR INJECTION */(function(FormData) {
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(/*! ./node_modules/sketch-polyfill-fetch/lib/form-data.js */ "./node_modules/sketch-polyfill-fetch/lib/form-data.js")))
...
var axios = __webpack_require__(/*! axios */ "./node_modules/axios/index.js"); // const httpClient = axios.create();
...
function removeBackground(objectWithImage, apiKey) {
  ...
  return fetch('https://api.slazzer.com/v2.0/remove_image_background', {
    ...
    if (!res.ok) {
      ...
      return res.text().then(function (text) {
        ...
        try {
          ...
          if (json && json.error) {
            message = json.error;
            console.log(message); // sketch.UI.message(message)
          }
        } catch (err) {}
    ...
    objectWithImage.image = response; //   response.text().then(text => {
    //     let message = text
    //     try {
...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  ...
  getApiKey().then(function (apiKey) {
    if (!apiKey) {
      sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message('Please enter your Slazzer API key first');
      return;
    }
